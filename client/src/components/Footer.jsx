...
function Footer() {
  return (
    <footer className=" bg-blueGray-200 pt-8 pb-6 mt-[200px] shadow-[0_3px_10px_rgba(0,0,0,0.25)]">
      <div className="container mx-auto px-4">
        ...
        <hr className="my-6 border-blueGray-300 shadow-[0_3px_10px_rgba(0,0,0,0.25)]" />
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="w-full md:w-4/12 px-4 mx-auto text-center">
            <div className="text-sm text-blueGray-500 font-semibold py-1">
              Copyright © <span id="get-current-year">2024 </span>Pallavi Rana JS by
              <a href="https://www.creative-tim.com?ref=njs-profile" className="text-blueGray-500 hover:text-blueGray-800 mx-1">Sqilco</a>.
            </div>
          </div>
        </div>
      </div>
